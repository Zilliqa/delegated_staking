...
//TODO: move the WithdrawalQueue library in a separate source file and import it here
//      or implement a common super contract both LiquidDelegation and NonLiquidDelegation
//      inherite from, providing functionalities such as claiming, taxation etc. 

contract NonLiquidDelegation is Initializable, PausableUpgradeable, Ownable2StepUpgradeable, UUPSUpgradeable {
    ...
    struct Storage {
        //TODO: remove address lst;
        bytes blsPubKey;
        bytes peerId;
        uint256 commissionNumerator;
        //TODO: remove uint256 taxedRewards;
        //TODO: uncomment mapping(address => WithdrawalQueue.Fifo) withdrawals;
        uint256 totalWithdrawals;
    }

    // keccak256(abi.encode(uint256(keccak256("zilliqa.storage.NonLiquidDelegation")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant STORAGE_POSITION = 0x66c8dc4f9c8663296597cb1e39500488e05713d82a9122d4f548b19a70fc2000;
    ...
    function unstake(uint256 value) public {
        ...
        //TODO: queue the withdrawal request so that it can be claimed after the unbonding period
    }
    ...
    function withdrawRewards(uint256 amount, uint256 additionalWithdrawals) public {
